                        ...
                        <div className="col-12 col-sm-8">
                            <div className="button-wrap d-flex gap-4">
                                <div className="dropdown">
                                    <button className="btn btn-dark text-white dropdown-toggle" type="button"
                                        ...
                                        {[...new Set(data.map((item) => item.company))].map(
                                            (company) => (
                                                <li key={company} onClick={() => handleCompanyFilter(company)}>
                                                    <span className="dropdown-item ps-3 py-1" title={company}>
                            ...
                            <table className="table table-bordered table-striped table-hover shadow">
                                ...
                                <tr>
                                    <th onClick={() => handleSort("company")}>
                                        Company{" "}
                                        {sort.column === "Unternehmen" && (sort.order === "asc" ? "▲" : "▼")}
                                    </th>
                                    <th onClick={() => handleSort("country")}>
                                        Country{" "}
                                        {sort.column === "Land" && (sort.order === "asc" ? "▲" : "▼")}
                                    </th>
                                    <th>
                                        CO2-Emissionen (t/a)
                                    </th>
